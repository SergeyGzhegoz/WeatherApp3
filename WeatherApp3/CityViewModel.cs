    ...
    internal class CityViewModel: INotifyPropertyChanged
    {
        ...
        private async void LoadData()
        {
            ...
            try
            {
                ...
                var units = o.SelectToken(@"$.current_units");
                var current_weatherInfo = JsonConvert.DeserializeObject<WeatherInfo>(str.ToString());
                var current_units = JsonConvert.DeserializeObject<WeatherCurrentUnits>(units.ToString());
                ...
                this.CurrentUnits = new BindingList<WeatherCurrentUnits> { current_units };
            }
            catch (Exception ex)
            {
                this.Windspeed = 404;
        ...
        public BindingList<WeatherCurrentUnits> CurrentUnits
        {
            get { return city.CurrentUnits; }
            set { city.CurrentUnits = value; OnPropertyChanged("CurrentUnits"); }
        }
